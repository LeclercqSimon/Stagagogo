...
class DBcompany{
    ...
    public function insertCompany($name, $city, $sector, $mail, $phone, $description, $siret){
        $stmt = $this->pdo->prepare("INSERT INTO company (name_company, city_company, sector_company, mail_company, phone_company, description_company, siret_company) VALUES (:name, :city, :sector, :mail, :phone, :description, :siret)");
